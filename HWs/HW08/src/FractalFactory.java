...
public class FractalFactory {
    ...
    */
    private static int drawFractal(int corner, int size, int x, int y, double factor, Pane pane) {
        ...
        Color[] palette = new Color[] {Color.RED, Color.BLUE, Color.ORANGE, Color.GREEN, Color.YELLOW, Color.GREY
                , Color.VIOLET, Color.CHOCOLATE};
        ...
        if (size < 1) {
            ...
            rectangle.setFill(palette[rand.nextInt(palette.length)]);
